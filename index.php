...
<div class='header'>
  ...
  if ($_SESSION['userid']) {
    echo "<div class='userStatus'><div class='loggedIn'>Signed is as:<br>".$_SESSION['userid']."</div>
    <div class='container logout'><form method='post' action='logout.php'><input type='submit' value='Logout' name='logout'/></form></div></div>";
  } else { 
